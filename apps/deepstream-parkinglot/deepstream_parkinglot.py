...
def nvanalytics_src_pad_buffer_probe(pad,info,u_data):
    ...
    while l_frame:
        ...
        print("source_id=",frame_meta.source_id ,"Frame Number=", frame_number, "stream id=", frame_meta.pad_index, "Number of Objects=",num_rects,"Vehicle_count=",obj_counter[PGIE_CLASS_ID_VEHICLE],"Person_count=",obj_counter[PGIE_CLASS_ID_PERSON])
